...
@section('content')
<div style="animation:fadeUp .45s both;max-width:860px;margin:0 auto;height:100%;display:flex;flex-direction:column;" data-client-assistant-root>
    <div style="background:var(--surface);border:1px solid var(--border);border-radius:16px;padding:0;box-shadow:var(--shadow);overflow:hidden;flex:1;display:flex;flex-direction:column;">
        <div style="padding:16px 20px;border-bottom:1px solid var(--border);display:flex;align-items:center;gap:12px;">
            ...
            <div style="flex:1;">
                <div style="font-weight:800;font-size:16px;color:var(--text);">Assistant client</div>
                <div style="font-size:12px;color:#16a34a;display:flex;align-items:center;gap:5px;">
                    ...
                    <span>Réponses basées sur les articles validés</span>
                </div>
            </div>
        </div>
        ...
        <div style="flex:1;overflow-y:auto;padding:22px;display:flex;flex-direction:column;gap:16px;" data-assistant-messages>
            <div data-assistant-empty style="text-align:center;padding:60px 20px;color:var(--muted);">
                ...
                <div style="font-size:13px;color:var(--text2);line-height:1.5;max-width:420px;margin:0 auto;">Je vous réponds en m'appuyant sur nos articles validés. Posez votre question ci-dessous !</div>
            </div>
        </div>

        <div style="padding:16px 20px;border-top:1px solid var(--border);">
            <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:12px;" data-assistant-suggestions>
                <button data-suggestion-btn data-question="Comment réinitialiser mon mot de passe ?" style="padding:7px 13px;border:1px solid var(--border);border-radius:100px;background:var(--surface2);color:var(--text2);font-size:12px;font-weight:600;font-family:inherit;cursor:pointer;transition:.15s;" onmouseover="this.style.borderColor='var(--accent)';this.style.color='var(--accent)'" onmouseout="this.style.borderColor='var(--border)';this.style.color='var(--text2)'">Comment réinitialiser mon mot de passe ?</button>
                <button data-suggestion-btn data-question="Où voir mes factures ?" style="padding:7px 13px;border:1px solid var(--border);border-radius:100px;background:var(--surface2);color:var(--text2);font-size:12px;font-weight:600;font-family:inherit;cursor:pointer;transition:.15s;" onmouseover="this.style.borderColor='var(--accent)';this.style.color='var(--accent)'" onmouseout="this.style.borderColor='var(--border)';this.style.color='var(--text2)'">Où voir mes factures ?</button>
                <button data-suggestion-btn data-question="Inviter un collègue à rejoindre l'équipe" style="padding:7px 13px;border:1px solid var(--border);border-radius:100px;background:var(--surface2);color:var(--text2);font-size:12px;font-weight:600;font-family:inherit;cursor:pointer;transition:.15s;" onmouseover="this.style.borderColor='var(--accent)';this.style.color='var(--accent)'" onmouseout="this.style.borderColor='var(--border)';this.style.color='var(--text2)'">Inviter un collègue</button>
            </div>
