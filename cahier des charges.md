...
| :---- | :---- |
| Administrateur | Gère les comptes agents les catégories et les articles ; consulte le tableau de bord global. |
| Agent de support | Consulte, traite et répond aux tickets ; sollicite et valide l'assistance IA. |
| Client | Soumet une demande, consulte les réponses et échange avec le support.  |
...
| Intelligence Artificielle | Laravel AI \+ API Groq |
| Traitement asynchrone | Laravel Queues & Jobs |
| Tests | Pest |
